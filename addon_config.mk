...
meta:
	ADDON_NAME = ofxQt
	ADDON_DESCRIPTION = ofxQt is and addon providing a set of tools and codes to let OpenFrameworks and Qt be good friends.
	ADDON_AUTHOR = @wasawi
	ADDON_TAGS = "addon" "template"
	ADDON_URL = http://github.com/jordiexvision/ofxQt
...
common:
	...
	ADDON_INCLUDES = $(QTDIR)\include\;$(QTDIR)\include\QtCore
	+=$(QTDIR)\include\QtGui
